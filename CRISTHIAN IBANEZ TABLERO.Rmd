# MAESTRIA EN CIENCIA DE DATOS UNIVERSIDAD PONTIFICIA JAVERIANA CALI

# MÉTODOS Y SIMULACIÓN ESTADÍSTICA

#CRISTHIAN CAMILO IBÁÑEZ BERSINGER #ACTIVIDAD N°1 UNIDAD 1: ACTIVIDAD 1 CREACIÓN DE TABLERO
...
```{r}
paleta6=c("#00F5FF", "#FFFF00", "#FF3E96", "#35D225", "#35D225", "#FFFF00")
p1=ggplot(CarreraLuz22F, aes(y=timerun/60, x=categoria))+
  geom_jitter(color="#FF0000", size=1, alpha=0.9) +
  aes(color=paleta6)+
  labs(title = " ",
       y= "tiempo - min",
       x= "categorías")+ 
...
ggplot(CarreraLuz22M, aes(x = categoria, y = timerun/60 )) +
  ...
  scale_fill_brewer() +
  #scale_fill_manual(values = c("#FF3E96", "#00E5EE", "#00FF7F", "#0570E1", "#3998FB","#37B6FC"))+
